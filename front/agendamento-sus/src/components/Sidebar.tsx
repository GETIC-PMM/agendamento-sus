...
const Sidebar = (props: SidebarProps) => {
  ...
  return (
    <div
      className={`w-screen md:w-[250px] bg-primary-base h-auto py-9 transition-all ${
        props.isVisible ? '' : '-translate-x-[250px] relative hidden h-full'
      }`}
    >
      <div>
        <button
          ...
          className={`text-white flex w-full items-center gap-3 text-md font-light py-3 px-2 border-l-4 border-primary-base-alt
                        ${
                          props.activeSidebar === 'inicio'
                            ? 'bg-primary-dark border-primary-base-alt'
                            : 'bg-primary-base-alt border-primary-light'
                        }`}
        >
          <AiFillHome />
          Dashboard
        ...
        <button
          ...
          className={`text-white flex w-full items-center gap-3 text-md font-light py-3 px-2 border-l-4 border-primary-base-alt
                        ${
                          props.activeSidebar === 'cadastrar-unidades'
                            ? 'bg-primary-dark border-primary-base-alt'
                            : 'bg-primary-base-alt border-primary-light'
                        }`}
        >
        ...
        <button
          ...
          className={`text-white flex items-center gap-3 w-full text-md font-light py-3 px-2 border-l-4 border-primary-base-alt
                        ${
                          props.activeSidebar === 'tipo-atendimento'
                            ? 'bg-primary-dark border-primary-base-alt'
                            : 'bg-primary-base-alt border-primary-light'
                        }`}
        >
        ...
        <button
          ...
          className={`text-white flex w-full items-center gap-3 text-md font-light py-3 px-2 border-l-4 border-primary-base-alt
                        ${
                          props.activeSidebar === 'cadastrar-agentes'
                            ? 'bg-primary-dark border-primary-base-alt'
                            : 'bg-primary-base-alt border-primary-light'
                        }`}
        >
